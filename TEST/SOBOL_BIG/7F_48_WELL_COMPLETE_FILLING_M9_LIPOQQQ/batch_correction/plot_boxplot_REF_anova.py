...
ctrl_data = data[data['SampleType'] == 'REF']
...
plt.title(f'SurfactinC Concentration by Batch and Sample Type (REF Only) - ANOVA p-value: {p_value_decimal}', fontsize=16)
plt.tight_layout()
...
# Save the plot
plt.savefig('surfactinc_concentration_ref_boxplot.png', dpi=600, transparent=True)
plt.close()
