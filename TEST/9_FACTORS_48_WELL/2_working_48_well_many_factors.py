...
#samples["extra"]=400
if (maxwell-dim*maxvol)!=0:
    samples["water"]=maxwell-dim*maxvol

#reference values, all volumes set to maxvol
ref_values=pd.DataFrame({"sample":["0_REF","0_CTRL"],"Glucose":[maxvol]*2,"NH4NO3":[maxvol]*2,"MgSO4":[maxvol]*2,"KH2PO4":[maxvol]*2,
        "Na2HPO4":[maxvol]*2,"Na2EDTA":[maxvol]*2,"CaCl2":[maxvol]*2,"FeSO4":[maxvol]*2,"MnSO4":[maxvol]*2})
...
rackcode={"Glucose":"1","NH4NO3":"1","MgSO4":"2","KH2PO4":"2",
        "Na2HPO4":"3","Na2EDTA":"3","CaCl2":"4","FeSO4":"4","MnSO4":"5"}
